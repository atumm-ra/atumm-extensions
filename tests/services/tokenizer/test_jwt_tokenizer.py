...
from atumm.services.user.domain.exceptions import DecodeTokenException, ExpiredTokenException
import time
...
class TestJWTTokenizer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tokenizer = JWTTokenizer(self.secret_key, self.expire_period, self.jwt_algorithm)
